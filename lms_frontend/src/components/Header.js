                ...
                { studentLoginStatus !== 'true' && 
                  <li className="nav-item dropdown">
                    ...
                    }
                    {
                      ...
                      <li><Link className="dropdown-item" to="instructor-dashboard">Dashboard</Link></li>
                      <li><a className="dropdown-item" href="instructor-logout">Logout as {instructorData.full_name}</a></li>
                      </>
                    }
                  ...
                  <li className="nav-item dropdown">
                    ...
                    }
                    {
                      ...
                      {/* <li><hr className="dropdown-divider"/></li> */}
                      <li><Link className="dropdown-item" to="user-dashboard">Dashboard</Link></li>
                      <li><a className="dropdown-item" href="user-logout">Logout as {studentData.full_name}</a></li>
                      </>
                    }
                    </ul>
