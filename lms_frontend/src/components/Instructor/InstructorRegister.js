...
const baseUrl = 'http://3.145.99.183:8000/api/instructor/'
                        ...
                        <div className='card-body'>
                            <form>
                                ...
                                <div className="pt-1 mb-4">
                                    <button onClick={submitForm} type='button' className="btn btn-lg btn-block text-white mx-2" style={LoginText}>Sign Up</button>
                                    <button onClick={submitForm} type='button' className="btn btn-lg btn-block text-white" style={LoginText}><i class="bi bi-google"></i></button>
                                </div>
